...
var CustomizeComposer = function CustomizeComposer(handleSend) {
  ...
  var handleSendMsg = useCallback( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return handleSend('text', inputValue);
        case 2:
          setInputValue('');
        case 3:
        case "end":
  ...
  if (!browserSupportsSpeechRecognition) {
    return /*#__PURE__*/React.createElement("span", null, "Browser doesn\u2018t support speech recognition.");
  }
